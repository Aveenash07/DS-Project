	...
	public patientStatus() {
		...
		Assign.addActionListener(new ActionListener() {
			...
			try {
				...
				/*
				 * Encapsulation concept is being utilized here to avoid incorrect data
				 */
				 ...
				 */
				FileWriter write = new FileWriter(new File("src//records.txt"),true);
                ...
                if(new File("src//drsTimingForNormal.txt").length() == 0)
                {
                	FileWriter file = new FileWriter(new File("src//drsTimingForNormal.txt"));
                ...
                {
                	Scanner scan = new Scanner(new File("src//drsTimingForNormal.txt"));
		...
		btnFlushThePrevious.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					FileWriter file1 = new FileWriter(new File("src//dr1.txt"));
					FileWriter file2 = new FileWriter(new File("src//dr2.txt"));
					FileWriter file3 = new FileWriter(new File("src//dr3.txt"));
					FileWriter file = new FileWriter(new File("src//drsTimingForNormal.txt"));
		...
		lblNewLabel_1_1_1_1_1_1.setForeground(SystemColor.menu);
		lblNewLabel_1_1_1_1_1_1.setFont(new Font("SansSerif", Font.BOLD, 15));
		...
		lblNewLabel_1_1_1_1_1_2.setForeground(SystemColor.menu);
		lblNewLabel_1_1_1_1_1_2.setFont(new Font("SansSerif", Font.BOLD, 15));
		...
		lblNewLabel_1_1_1_1_1_3.setForeground(SystemColor.menu);
		lblNewLabel_1_1_1_1_1_3.setFont(new Font("SansSerif", Font.BOLD, 15));
		...
		lblNewLabel_1_1_1_1_1_3_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1_1_1_1_1_3_1.setForeground(SystemColor.menu);
		lblNewLabel_1_1_1_1_1_3_1.setFont(new Font("SansSerif", Font.BOLD, 15));
		lblNewLabel_1_1_1_1_1_3_1.setBounds(35, 280, 125, 20);
		contentPane.add(lblNewLabel_1_1_1_1_1_3_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("src//pic2.PNG"));
		lblNewLabel_2.setBounds(0, 0, 784, 487);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_1_1_1_1_1_4 = new JLabel("Name");
		lblNewLabel_1_1_1_1_1_4.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1_1_1_1_1_4.setForeground(SystemColor.menu);
		lblNewLabel_1_1_1_1_1_4.setFont(new Font("SansSerif", Font.BOLD, 15));
		lblNewLabel_1_1_1_1_1_4.setBounds(78, 281, 71, 20);
